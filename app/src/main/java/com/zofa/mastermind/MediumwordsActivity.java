...
public class MediumwordsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mediumwords);
                        ...
                        if(dword.toString().equals(w)){
                            ...
                            class dbprocess extends AsyncTask<String,Void,String>
                            {
                                ...
                                protected  void onPostExecute(String data)
                                {
                                    ...
                                    {
                                        Toast.makeText(getApplicationContext(), "10 points added", Toast.LENGTH_LONG).show();
                                    }
                                    else
                                    {
                            ...
                            class dbprocess extends AsyncTask<String,Void,String>
                            {
                                ...
                                protected  void onPostExecute(String data)
                                {
                                    if(data.equals("found"))
                                    {
                                        Toast.makeText(getApplicationContext(), "-10 points ", Toast.LENGTH_LONG).show();
                                    }
                                    else
                                    {
                                        Toast.makeText(getApplicationContext(), "Error", Toast.LENGTH_LONG).show();
