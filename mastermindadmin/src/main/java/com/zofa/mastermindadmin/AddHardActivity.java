...
public class AddHardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pass = findViewById(R.id.hardtest);
        name = findViewById(R.id.hardword);
        btn = (MaterialButton) findViewById(R.id.hardbtn);
    ...
    private void easyword() {
        ...
        String qry="?email="+dusername+"&pass="+dpassword+"&level=3";
        ...
        class dbprocess extends AsyncTask<String,Void,String>
        {
            ...
            protected  void onPostExecute(String data)
            {
                if(data.equals("found"))
                {
                    ...
                    Toast.makeText(AddHardActivity.this, "Word Added", Toast.LENGTH_LONG).show();
                }
                else
                {
                    name.setText("");
                    pass.setText("");
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(AddHardActivity.this, "Failed to Add", Toast.LENGTH_LONG).show();
