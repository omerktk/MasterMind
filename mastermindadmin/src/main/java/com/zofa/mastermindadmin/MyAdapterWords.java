...
public class MyAdapterWords extends BaseAdapter {

    List<com.zofa.mastermindadmin.ModelMindWords> data;
    Context context;

    public MyAdapterWords(List<com.zofa.mastermindadmin.ModelMindWords> data, Context context) {
        this.data = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv.setText("Word : "+data.get(position).getScore());
